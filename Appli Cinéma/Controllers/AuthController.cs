...
namespace Appli_Cinéma.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        private readonly IOptionsSnapshot<JwtSetting> _jwtSettings;

        public AuthController(IMapper mapper, UserManager<User> userManager, RoleManager<Role> roleManager, IOptionsSnapshot<JwtSetting> jwtSettings)
        {
            _mapper = mapper;
        ...
        public async Task<IActionResult> SignIn([FromBody] UserLoginDTO userLoginDTO)
        {
            ...
            if (user is null)
            {
                return NotFound("L'adresse e-mail n'existe pas.");
            }
